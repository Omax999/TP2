...
public class Test {
    public static void main(String[] args) {
        ...
        //  6.a.Un objet (o1) en utilisant le constructeur sans paramètres
        Salle o1 = new Salle();

        //  6.b.Un objet (o2) ayant le nom “Salle Informatique”
        Salle o2 = new Salle("Salle Informatique");

        //  6.b.Un objet (o3) ayant l’id 2 et le nom “Salle des cours”
